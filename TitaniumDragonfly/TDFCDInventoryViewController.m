//
//  TDFCDInventoryViewController.m
//  TitaniumDragonfly
//
...
#import "TDFCDInventoryViewController.h"
#import "InventoryItem.h"
#import "TDFAppDelegate.h"

@interface TDFCDInventoryViewController ()

@end

@implementation TDFCDInventoryViewController
...
- (void)viewDidLoad
{
    ...
    NSError *error;
    self.inventoryItems = [managedObjectContext executeFetchRequest:fetchRequest error:&error];
...
- (UITableViewCell *)tableView:(UITableView *)tableView
    ...
    // Set up the cell...
    InventoryItem *item = [inventoryItems objectAtIndex:indexPath.row];
